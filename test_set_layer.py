...
class TestSetLayer(unittest.TestCase):
    ...
    def test_layers(self):
        ...
        s.add(lighten)
        self.assertEqual(s.get_color(
            (100, 100, 100), 0, 20, 40), (140, 140, 140))
    ...
    def test_special(self):
        ...
        s.add(lighten)
        self.assertEqual(s.get_color(
            (100, 100, 100), 0, 0, 0), (140, 140, 140))
        s.special()
        self.assertEqual(s.get_color((100, 100, 100), 0, 0, 0),
